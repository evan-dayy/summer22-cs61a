...
class FreeChecking(Account):
    ...
    def __init__(self, account_hol):
        super().__init__(account_hol)
        self.free_withdrawals1 = FreeChecking.free_withdrawals


    def withdraw(self, amount):
        if self.free_withdrawals1 > 0:
            self.free_withdrawals1 -= 1
