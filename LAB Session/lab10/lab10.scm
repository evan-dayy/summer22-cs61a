...
(define (student-attend-class student class)
  (student-create (student-get-name student) (append (list class) (student-get-classes student)))
)
...
(define (teacher-hold-class teacher)
    (teacher-create 
        ...
        (map 
          (lambda(student) (student-create (student-get-name student) (append (list (teacher-get-class teacher)) (student-get-classes student))))
