...
class AICard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        # BEGIN Problem 3
        implemented = True
        card1 = player.deck.cards.pop()
        card2 = player.deck.cards.pop()
...
class TutorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        added = True
        if player.hand:
            card_copy = player.hand[0].copy()
            player.hand.append(card_copy)
        else:
            added = False
    ...
    def effect(self, opponent_card, player, opponent, arg=None):
        ...
        if player.hand:
            ...
            for i in player.hand:
                if i.power(opponent_card) > power:
                    best_card = i
                    power = i.power(opponent_card)
